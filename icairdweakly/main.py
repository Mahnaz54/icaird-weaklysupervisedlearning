...
def main(args):
    ...
    for i in folds:
        ...
        test_results = pd.DataFrame(test_results, columns = ['slide','actual_label', 'predicted_label'])
...
parser.add_argument('--drop_out', action='store_true', default=False, help='enabel dropout (p=0.3)')
