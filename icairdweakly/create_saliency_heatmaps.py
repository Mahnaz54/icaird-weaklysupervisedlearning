...
if __name__ == '__main__':
    ...
    for i in range(len(process_stack)):
        ...
        heatmap_vis_args = {
            'convert_to_percentiles': True, 'vis_level': heatmap_args.vis_level, 'blur': heatmap_args.blur,
        ...
        heatmap_save_name = '{}_{}_roi_{}_blur_{}_rs_{}_bc_{}_a_{}_l_{}_bi_{}_{}.{}'.format(slide_id,
                                                                                            ...
                                                                                            int(heatmap_args.blur), int(
                heatmap_args.use_ref_scores), int(heatmap_args.blank_canvas), float(heatmap_args.alpha),
