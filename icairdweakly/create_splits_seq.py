...
if args.task == 'task_1_tumor_vs_normal':
    args.n_classes=2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/cervical_clean_normal_vs_malignant.csv',
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
                            label_dict = {'normal_inflammation':0, 'malignant':1},
                            patient_strat=True,
                            ignore=[])
    ...
    args.n_classes = 4
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/cervical_clean.csv',
                            shuffle = False,
                            seed = args.seed,
                            print_info = True,
                            label_dict = {'normal_inflammation':0, 'low_grade':1, 'high_grade':2, 'malignant':3},
                            patient_strat= True,
                            patient_voting= 'maj',
                            ignore=[])
else:
