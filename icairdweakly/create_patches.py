...
def seg_and_patch(source, save_dir, patch_save_dir, mask_save_dir, stitch_save_dir, 
    ...
    for i in range(total):
	    	...
	    	# If slide is scanned with just one zoon level then set the visualization level to zero, else downsample the slide to level 6
            ...
            print('Image is scanned at level = {} and will be segmented at level = {} and visualised at level = {}'.format(img_lvl, current_seg_params['seg_level'],current_vis_params['vis_level']))
...
if __name__ == '__main__':
		...
		# Set the segmentation, filtering and visulization parameters and parameters used for patching
        seg_params = {'seg_level': -1, 'sthresh': 10, 'mthresh': 7, 'close': 4, 'use_otsu': False,
                                  'keep_ids': 'none', 'exclude_ids': 'none'}
        filter_params = {'a_t':100, 'a_h': 16, 'max_n_holes':20}
