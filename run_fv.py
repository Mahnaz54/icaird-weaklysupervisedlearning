...
from icairdweakly.datasets.dataset_generic import Generic_MIL_Dataset
...
parser.add_argument('--ckpt', default='results/Endometrial/Results_Feb2022/Endo_all_classes_CLAM_sb_small/s_0_checkpoint.pt')
